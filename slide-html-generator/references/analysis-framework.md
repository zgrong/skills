...
| Technical | Architecture, implementation, specs | Detailed diagrams, schematics |
| General | Benefits, stories, relatability | Visual metaphors, simple charts |
| Investors | Market size, traction, team | Growth charts, milestones |
...
**Slug:** {topic-slug}
**Language:** {zh/en}
**Style:** {preset} (recommended based on content signals)
...
- {Opportunity 1}: {visualization type}
- {Opportunity 2}: {visualization type}

## Recommended Structure
1. Cover - {title}
2. Contents - {overview}
3. {Section 1} - {slides N-M}
4. {Section 2} - {slides N-M}
...
N. Back Cover - {closing}
